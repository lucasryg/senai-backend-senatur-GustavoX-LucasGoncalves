...
Values ('SALVADOR-5 DIAS/4DIÁRIAS','O que não falta em Salvador são atrações. Prova disso são as praias, os
...
estrangeiros. O Pelourinho e o Elevador são alguns dos principais pontos de visitação.' , '06/08/2020' , '10/08/2020','854.00',1,'Salvador'),

('RESORTS NA BAHIA-LITORALNORTE-5 DIAS/4 DIÁRIAS' ,'O Litoral Norte da Bahia conta com
...
Praia do Forte e Costa do Sauipe.' , '14/05/2020', '18/05/2020', '1826.00' , 1,  'Salvador'),

('BONITO VIA CAMPO GRANDE-1PASSEIO-5 DIAS/ 4 DIÁRIAS','Localizado no estado de Mato Grosso do
...
região.' ,'28/03/2020' , '01/04/2020' , '1004.00' , 1, 'Bonito');

Insert into TiposUsuario (Titulo)
Values ( 'ADMINISTRADOR') ,( 'CLIENTE');

Insert into Usuarios ( Email , Senha , IdTipoUsuario)
Values ( 'admin@admin.com' ,  'admin' , 1) , ('clinete@clinete.com' , 'cliente' , 2);